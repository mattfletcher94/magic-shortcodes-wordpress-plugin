...
class Magic_Shortcodes_Public {
	...
	public function enqueue_scripts() {
		...
		// Enqueue scripts
		wp_enqueue_script($this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/magic-shortcodes-public.js', array('jquery'), $this->version, true);
		...
		wp_localize_script($this->plugin_name, 'magic_shortcodes', array(
			'popups' => $popups,
			'page_id' => get_the_ID(),
